...
const totalContribution = GAMES_JSON.reduce(
    (total, game) => total + game.backers, 0);
...
const totalPledged = GAMES_JSON.reduce(
    (total, game) => total + game.pledged, 0);
...
const totalNumGames = GAMES_JSON.reduce(
    (total, game) => total + 1, 0);
...
const displayStr =
    `A total of $${totalContribution} has been raised for ${totalNumGames} games. Currently, ${numUnfundedGames} 
